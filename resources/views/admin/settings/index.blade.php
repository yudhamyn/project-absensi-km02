                            ...
                            <form action="{{ url('') }}/admin/settings/{{ $settings->id }}" method="post">
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="time" name="jam_keluar" value="{{ $settings->jam_keluar }}">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" name="latitude_longitude" value="{{ $settings->latitude }}, {{ $settings->longitude }}">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" name="batas_jarak" value="{{ $settings->batas_jarak }}">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card" style="height: 400px;">
                        <div class="card-body">
                            <iframe style="width: 100%; height: 100%;" src="https://www.google.com/maps?q={{ $settings->latitude }},{{ $settings->longitude }}&hl=es;z=14&output=embed"></iframe>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <button type="button" class="btn btn-info stripes-btn" style="width: 100%;"> Jam Masuk {{ $settings->jam_masuk }}</button>
                            <button type="button" class="btn btn-info stripes-btn mt-3" style="width: 100%;"> Jam Keluar {{ $settings->jam_keluar }}</button>
                        </div>
                    </div>
                </div>
            </div>
